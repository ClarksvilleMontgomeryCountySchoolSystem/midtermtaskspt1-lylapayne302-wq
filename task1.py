...
days_to_milestone = (milestone_increment - days_to_milestone) // weekly_growth
...
print(f"Days to Next Milestone: {days_to_next_milestone}")
print(f"Weekly Growth Projection: {weekly_growth_projection}")
